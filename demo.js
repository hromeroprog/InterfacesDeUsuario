...
$(document).ready(function() {
    ...
    $("#addBtn").click(function(a) {
        ...
        $("#calendar_news").evoCalendar("addCalendarEvent", events[curAdd]);
    ...
    $("#removeBtn").click(function(a) {
        ...
        $("#calendar_news").evoCalendar("removeCalendarEvent", active_events[curRmv].id);
    ...
    function a(a) {
        ...
        $(a).addClass("active");
        $("#calendar_news").evoCalendar("setTheme", b);
    }
